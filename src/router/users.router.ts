...
import { deleteUser, getAllUsers, getUserById, getUserByEmail, getUserByUsername, getUserMovies, deleteUserByName } from '../controllers/users.controller'
...
export default (router : express.Router)=>{
	...
	router.get('/users/movies/:id', getUserMovies)
